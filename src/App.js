...
function App() {
  ...
  function resetHandler(){
   ...
   return (
    <div className="w-[100vw] h-[100vh] flex justify-center items-center bg-[#344151] flex-col gap-10 font-medium">
      <div className="text-[#0398d4] font-medium text-4xl">Increment and Decrement</div>
